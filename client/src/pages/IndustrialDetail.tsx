...
import { MapPin, DollarSign, CheckCircle2, ArrowLeft, Share2, Phone, Mail, Ruler, Building2 } from "lucide-react";
...
export default function IndustrialDetail() {
  const [, params] = useRoute("/industrial/:id");
  const [listing, setListing] = useState<IndustrialListing | null>(null);
  ...
  useEffect(() => {
    ...
    fetch('/data/industrial.json')
      ...
      .then(data => {
        const found = data.find((item: IndustrialListing) => item.id === params.id);
  ...
  const typeLabel = listing.type === 'lease' ? '出租' : '出售';
  const typeColor = listing.type === 'lease' ? 'bg-blue-500' : 'bg-green-500';
        ...
        <div className="container flex items-center justify-between">
          <Link href="/industrial-warehouse">
            <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-primary pl-0">
              <ArrowLeft className="w-4 h-4 mr-2" /> 返回工业仓库列表
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="lg:hidden space-y-4">
              <span className={`${typeColor} text-white px-3 py-1 rounded-full text-sm font-bold`}>
                {typeLabel}
              </span>
            ...
            {/* Features */}
            <div className="space-y-6">
              <h2 className="text-2xl font-bold border-b border-border pb-4">核心特色</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="font-bold text-lg">{typeLabel}</div>
                </CardContent>
              </Card>
              <Card className="bg-secondary/5 border-secondary/20">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-sm text-muted-foreground mb-1">面积</div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="hidden lg:block space-y-4 p-6 rounded-xl border border-border bg-card shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div>
                    <div className="text-sm text-muted-foreground mb-1">面积</div>
                    <div className="text-xl font-bold text-primary">{listing.size}</div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground mb-1">价格</div>
              ...
              <Card className="border-primary/20 shadow-md overflow-hidden">
                <div className="bg-primary p-4 text-primary-foreground text-center">
                  <h3 className="font-bold text-lg">对该房源感兴趣？</h3>
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">资深工业地产经纪人</div>
